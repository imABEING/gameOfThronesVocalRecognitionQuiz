...
int main()
   ...
   if(csdPointer != NULL)
	...
	fprintf(csdPointer," a1 oscili 10000, p5, 1\n");
	...
	fprintf(csdPointer,"i \"testing\" 1.9 2 0 440\n");
	fprintf(csdPointer,"i \"testing\" 1.9 2 0 494\n");
	fprintf(csdPointer,"i \"testing\" 1.9 2 0 523\n");
	fprintf(csdPointer,"i \"testing\" 1.9 2 0 330\n");
