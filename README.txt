GAME OF THRONES VOCAL RECOGNITION QUIZ
	...
	Once compiled and run, program opens with a welcome screen accompanied by the CsoundSynthesizer playing the chord tones of an A minor chord sequentially, then simultaneously.
